    ...
    return new Promise((resolve, reject) => {
      ...
      reader.onload = async (e) => {
        try {
          ...
          const tempAudioContext = new (window.AudioContext || (window as unknown as { webkitAudioContext: typeof AudioContext }).webkitAudioContext)({ sampleRate: 22050 });
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-teal-50 dark:from-slate-950 dark:to-slate-900 relative overflow-hidden transition-colors duration-300">
        ...
        <div className="relative z-10 text-center pt-8 pb-10 px-4">
          <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-teal-600 to-cyan-600 dark:from-teal-400 dark:to-cyan-400 bg-clip-text text-transparent mb-4 tracking-tight">
            MoodStream
          </h1>
          <h2 className="text-xl md:text-2xl text-teal-700 dark:text-teal-300 font-semibold mb-6 tracking-wide">
            Real-Time Voice Intelligence at the Edge of Emotion
          </h2>
          <p className="text-teal-600/80 dark:text-teal-400/80 text-lg md:text-xl max-w-4xl mx-auto leading-relaxed">
        ...
        <div className="relative z-10 flex items-center justify-center px-3 pb-8">
          ...
          <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl p-6 max-w-md w-full shadow-2xl border border-teal-100 dark:border-slate-700 relative overflow-hidden">
            {/* Card Shimmer Effect */}
            ...
            <div className="text-center relative z-10">
              {/* Header - Compact */}
              <div className="mb-4">
                <h1 className="text-4xl font-bold bg-gradient-to-r from-teal-600 to-teal-800 dark:from-teal-400 dark:to-cyan-400 bg-clip-text text-transparent mb-1 tracking-tight">
                  Voice Emotion
                </h1>
              ...
              <button
                ...
                className={`w-full py-3 px-6 rounded-2xl font-semibold text-white transition-all duration-300 relative overflow-hidden shadow-lg transform hover:scale-105 active:scale-95 ${isRecording
